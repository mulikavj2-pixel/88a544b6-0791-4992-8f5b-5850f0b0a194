...
export const metadata: Metadata = {
  title: "Coffee Haven - Premium Artisan Coffee Shop",
  description: "Discover freshly roasted artisan coffee at Coffee Haven. Premium beans, expert baristas, and cozy atmosphere. Visit us today.",
  keywords: "coffee shop, artisan coffee, espresso, cappuccino, cafe",
  metadataBase: new URL("https://coffeehaven.com"),
  alternates: {
    canonical: "https://coffeehaven.com"
  },
  openGraph: {
    title: "Coffee Haven - Premium Artisan Coffee",
    description: "Freshly brewed excellence in every cup",
    url: "https://coffeehaven.com",
    siteName: "Coffee Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765547345173-1jkbbrux.jpg",
        alt: "Coffee Haven hero image"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Coffee Haven",
    description: "Premium artisan coffee shop",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765547345173-1jkbbrux.jpg"]
  },
  robots: {
    index: true,
    follow: true
